class PostgisPostgresql11AT3 < Formula
  ...
  def install
    ...
    # This is caused by a misalignment between ./configure in postgres >= 11 and postgis
    mv "build-aux", "config"
    ...
    stage_path = File.join("stage", postgresql.opt_prefix)
